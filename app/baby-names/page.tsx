...
export default function BabyNamesPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-background pt-20 pb-16 relative overflow-hidden">
      ...
      {/* ── Hero Banner with African Background Photo ── */}
      <section className="relative py-24 px-6 overflow-hidden">
        {/* Background photo: African mother with newborn */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="https://images.unsplash.com/photo-1517673408408-f47c5ba7bbf6?auto=format&fit=crop&q=80&w=1600&h=500"
